...
var _areMomentRangesEqual = _interopRequireDefault(require("../utils/areMomentRangesEqual"));
...
describe('The DateRangePicker component', function () {
  beforeEach(function () {
    ...
    var getDateRangePicker = function getDateRangePicker(props) {
      props = _lodash["default"].extend({}, props);
      return /*#__PURE__*/_react["default"].createElement(_DateRangePicker["default"], props);
    };
    ...
    this.useDocumentRenderer = function (props) {
      _this.component = _this.renderedComponent = _reactAddonsTestUtils["default"].renderIntoDocument(getDateRangePicker(props));
    };
    this.useDocumentRendererWithComplexStates = function () {
      ...
      _this.nonSelectableRange = moment.range(moment(new Date(2002, 1, 15)), moment(new Date(2003, 1, 15)));
      var dateStates = [{
        state: 'enquire',
        range: moment.range(moment(new Date(2000, 1, 15)), moment(new Date(2001, 1, 15)))
      }, {
        state: 'unavailable',
  ...
  describe('contains PaginationArrow components', function () {
    it('2 of them', function () {
      this.useShallowRenderer();
      expect(this.renderedComponent.props.children[0].props.children[0].type).toBe(_PaginationArrow["default"]);
      expect(this.renderedComponent.props.children[0].props.children[2].type).toBe(_PaginationArrow["default"]);
    });
    ...
    it('the left one when clicked moves the calendar one month in the past', function () {
      ...
      var leftArrow = _reactAddonsTestUtils["default"].scryRenderedDOMComponentsWithClass(this.renderedComponent, 'DateRangePicker__PaginationArrowIcon')[0];
      _reactAddonsTestUtils["default"].Simulate.click(leftArrow);
    ...
    it('the right one when clicked moves the calendar one month in the future', function () {
      ...
      var rightArrow = _reactAddonsTestUtils["default"].scryRenderedDOMComponentsWithClass(this.renderedComponent, 'DateRangePicker__PaginationArrowIcon')[1];
      _reactAddonsTestUtils["default"].Simulate.click(rightArrow);
  ...
  describe('contains CalendarMonth components', function () {
    describe('which number is', function () {
      it('by default only one', function () {
        ...
        expect(this.renderedComponent.props.children[1][0].type).toBe(_CalendarMonth["default"]);
      });
    ...
    describe('for each component the highlighted date', function () {
      it('is set to null if it is not a moment', function () {
        ...
        var calendarMonthComponent = _reactAddonsTestUtils["default"].scryRenderedComponentsWithType(this.renderedComponent, _CalendarMonth["default"])[0];
        ...
        describe('if state.selectedStartDate is undefined', function () {
          ...
          describe('if the date is not disabled and is selectable', function () {
            ...
            it('if props.singleDateRange is true, it calls #highlightRange', function () {
              ...
              expect((0, _isMomentRange["default"])(range)).toBe(true);
              expect((0, _areMomentRangesEqual["default"])(range, moment.range(this.date, this.date))).toBe(true);
            });
          });
        });
      });
  ...
  describe('contains a Legend component', function () {
    it('if props.showLegend is defined', function () {
      ...
      expect(legendComponent.type).toBe(_Legend["default"]);
  ...
  describe('#nonSelectableStateRanges', function () {
    ...
    it('returns the expected range', function () {
      ...
      expect(list).toEqual(jasmine.any(_immutable["default"].List));
      expect((0, _areMomentRangesEqual["default"])(list.get(0).get('range'), this.nonSelectableRange)).toBe(true);
    });
  });
  ...
  describe('#sanitizeRange', function () {
    ...
    describe('if forwards is true', function () {
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2003, 1, 15))), true);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2002, 1, 15))))).toBe(true);
      });
      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2002, 1, 1))), true);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2006, 1, 15)), moment(new Date(2007, 1, 1))), true);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2006, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      it('otherwise it returns the full range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 17))), true);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 17))))).toBe(true);
      });
    });
    describe('otherwise', function () {
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2005, 1, 15))), false);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2003, 1, 15)), moment(new Date(2005, 1, 15))))).toBe(true);
      });
      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2002, 1, 1))), false);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2006, 1, 15)), moment(new Date(2007, 1, 1))), false);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2006, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      it('otherwise it returns the full range', function () {
        var range = this.renderedComponent.sanitizeRange(moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 17))), false);
        expect((0, _areMomentRangesEqual["default"])(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 17))))).toBe(true);
      });
    });
  });
  ...
  describe('#statesForRange', function () {
    ...
    it('returns the expected value if a one-day range is provided', function () {
      var range = moment.range(moment(new Date(2003, 1, 1)), moment(new Date(2003, 1, 1)));
    ...
    it('returns the expected value if a multi-day range is provided', function () {
      var range = moment.range(moment(new Date(2003, 1, 14)), moment(new Date(2003, 1, 16)));
      var list = this.renderedComponent.statesForRange(range);
      expect(list).toEqual(jasmine.any(_immutable["default"].List));
    ...
    describe('if state.highlightedRange is defined', function () {
      describe('and its start and end are two different days', function () {
        beforeEach(function () {
          ...
          this.highlightedRange = moment.range(moment(new Date(2005, 1, 1)), moment(new Date(2006, 1, 1)));
          this.highlightedDate = moment();
          this.renderedComponent.setState({
      ...
      describe('and its start and end are the same day and props.singleDateRange is true', function () {
        beforeEach(function () {
          ...
          this.highlightedRange = moment.range(moment(new Date(2005, 1, 1)), moment(new Date(2005, 1, 1)));
          this.highlightedDate = moment();
          this.renderedComponent.setState({
            highlightedRange: this.highlightedRange,
            selectedStartDate: this.selectedStartDate,
